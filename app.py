...
st.markdown("---")
st.subheader("This is a simple ***Black-Scholes*** option pricing model calculator.")
st.subheader("You can use this app to calculate the price of a **European** call or put option based on the ***Black-Scholes*** formula.")
